...
export default {
	...
	methods: {
		createMarketingPlan() {
			this.loading = true;
			this.requestsStore
				.startMarketingPlan(`Could you provide a 5-step marketing strategy for a company in the ${this.industry} industry, targeting ${this.targetAudience}? Please include the following for each step:
